...
export const timelineEvents = [
    {
        ...
        description: <><strong>8th March 2026</strong> - Sign up your team and choose your track</>,
        icon: <HiPencilAlt />,
        status: "upcoming",
    },
    {
        ...
        description: <><strong>24th – 27th March 2026</strong> - Upload your pitch deck (PPT) following the official template before the deadline</>,
        icon: <HiClock />,
        status: "upcoming",
    },
    {
        ...
        description: <><strong>28th March 2026</strong> - Last date to register your team for both tracks</>,
        icon: <HiClock />,
        status: "upcoming",
    },
    {
